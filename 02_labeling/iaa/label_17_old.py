...
SAVE_EVERY   = 50
MAX_CHARS    = 1500
WORKERS      = 8   # naikkan ke 12-16 kalau GPU masih santai
...
→ NOT_SPAM.
  ...
  NOT_SPAM: "Gaya editnya sih 𝓟𝓤𝓛𝓐𝓤... approve 👌"
             ↑ "PULAU" = common Indonesian word (island), no gambling signal
...
{{
  ...
  "reason":     "<short reason in English, max 20 words>",
  "source":     "llm"
}}
...
def label_comment(comment_text, retries=3):
    ...
    for attempt in range(retries):
        try:
            ...
            # Tolerant parser — ekstrak JSON object pertama
